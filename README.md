...
A small Retrieval-Augmented Generation application that answers questions about uploaded PDF and text folders. It starts with the Level 2 graduation project guide, and answers are generated by a local Ollama model with cited sources.

## Architecture

```mermaid
flowchart LR
    A[PDF or TXT folder] --> B[Text extraction and chunking]
...
![Project Guide Assistant with folder upload](assets/app-screenshot.png)
